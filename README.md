...
## install
```
npm i --save exchange-realtime-api
```

## code
```
import { BitbankApi } from 'exchange-realtime-api/exchanges/bitbank;
...
```
import { BitbankCandlestick } from 'exchange-realtime-api/exchanges/bitbank/bitbank-candlestick;
